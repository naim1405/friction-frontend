      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              {popularTasks.map((task) => (
                ...
                >
                  ...
                  <div className="mt-4 flex flex-wrap gap-2 text-xs text-slate-500">
                    ...
                    <span className="rounded-full bg-white px-3 py-1">
                      Cost BDT {task.estimatedCostBdt}
                    </span>
                  </div>
                </Link>
              ))}
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Real experiences help the best workflow rise to the top.
                  </p>
                </div>
              </div>
            ...
            <ContributionGate
              taskSlug={featuredTask.slug}
              taskTitle={featuredTask.title}
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
          <article className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Explain confusing forms, summarize next actions, and answer task
              questions in plain Bangla or English.
            </p>
          </article>
          <article className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Turn scattered locations into a useful order so people can finish
              more in fewer trips.
            </p>
          </article>
          <article className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300">
              Votes, comments, and AI optimization keep the platform learning
