            ...
            <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
                <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                    <div className="space-y-3">
                        <h2 className="text-xl font-semibold text-white">Nexus Console</h2>
                        <p className="max-w-md text-sm text-slate-300">
                            A clean, secure workspace for authentication flows and admin account management.
                        </p>
                        ...
                        <div className="grid gap-2 text-sm">
                            ...
                            {isLoggedIn && (
                                <>
                                    ...
                                    <Link href="/change" className="transition hover:text-white">
                                        Change Password
                                    </Link>
                                </>
                            )}
                ...
                <div className="mt-8 flex flex-col gap-2 border-t border-slate-800 pt-4 text-xs text-slate-400 sm:flex-row sm:items-center sm:justify-between">
                    <p>© {year} Nexus Console. All rights reserved.</p>
                    <p>Built for reliable admin authentication workflows.</p>
                </div>
            </div>
        </footer>
    );
